...
/*
 * Created by JFormDesigner on Wed Nov 04 18:17:49 EST 2015
 */
...
public class UserGUI {
    ...
    private void initComponents() {
        ...
        //======== UserGUI ========
        {
            UserGUI.setBackground(Color.white);
            Container UserGUIContentPane = UserGUI.getContentPane();
            ...
            Chirp1.setBackground(Color.cyan);

            //---- Chirp2 ----
            Chirp2.setText("TEST");
            Chirp2.setEditable(false);
            Chirp2.setForeground(Color.black);
            Chirp2.setBackground(Color.cyan);

            //---- Chirp3 ----
            Chirp3.setText("TEST");
            Chirp3.setForeground(Color.black);
            Chirp3.setBackground(Color.cyan);

            //---- Chirp4 ----
            Chirp4.setText("TEST");
            Chirp4.setForeground(Color.black);
            Chirp4.setBackground(Color.cyan);

            //---- Chirp5 ----
            Chirp5.setText("TEST");
            Chirp5.setBackground(Color.cyan);
            ...
            UserGUI.pack();
            UserGUI.setLocationRelativeTo(UserGUI.getOwner());
        }
